...
const initApp = () => {
    ...
    // Add button that removes only checked items
    ...
    // Add button that unchecks any checked items
...
// Modified this function to add strikethrough to list item text instead of removing from list
const addClickListenerToCheckbox = (checkbox) => {
    checkbox.addEventListener("click", (event) => {
        toDoList.crossoutItemOnList(checkbox.id);
        const crossedOutText = getLabelText(checkbox.id);
        updateScreenReaderConfirmation(crossedOutText, "crossed out");
    });
};
